              ...
              <div class="ibox">
                <div class="ibox-body">
                  <ul class="nav nav-tabs tabs-line">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#tab-2" data-toggle="tab"><i class="ti-settings"></i> Profile</a></li>
                    <li class="nav-item"><a class="nav-link" href="#tab-3" data-toggle="tab"><i class="ti-announcement"></i> Notifications</a></li>
                  </ul>
