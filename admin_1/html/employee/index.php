          ...
          <div class="row products-board">
            <div class="col-lg-3 col-sm-6">
              <div class="card"><img src="../assets/img/image.png"/>
                <div class="card-body"><a class="product-name" href="profile">Employee name</a>
                  ...
                  <div class="m-t-10 d-flex justify-content-between align-items-center">
                    <a href=""><button class="btn btn-outline-info btn-rounded"><i class="fa fa-eye font-16"></i> View Profile</button></a>
                  </div>
                </div>
              </div>
              <div class="card"><img src="../assets/img/image.png"/>
