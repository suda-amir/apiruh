                    ...
                    <form action="javascript:;">
                        ...
                        <div class="ibox-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-4 row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group-icon input-group-icon-left">                                      
                                                ...
                                                <input class="form-control" type="text" placeholder="Autocomplete ID by algo based on nature of employement">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4 row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group-icon input-group-icon-left">                                      
                                                <span class="input-icon input-icon-left"><i class="ti-id-badge"></i></span>
                                                <input class="form-control" type="text" placeholder="Enter GSTIN No">
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-4 col-md-4">
                                     <label for="input-file-now-custom-1">Invoices</label>
                                      <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/employee.png" />
                                </div>
                            </div>
